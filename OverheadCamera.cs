...
namespace AssemblyCSharpfirstpass
{
	public class OverheadCamera
	{
		...
		double distsance = 0.0;

		// the height we want the camera to be above the target
		double height = 10.0;

		double angularSmoothLag = 0.3;
		double angularMaxSpeed = 15.0;
		
		double heightSmoothLag = 0.3;
		
		double snapSmoothLag = 0.2;
		double snapMaxSpeed = 720.0;
		
		double clampHeadPositionScreenSpace = 0.75;
		
		double lockCameraTimeout = 0.2;
